...
# ═══════════════════════════════════════════════════════════════════════
use constant O_CLOEXEC => 0x00080000;
...
use constant {
    ...
    SECCOMP_FILTER_FLAG_TSYNC => 0x00000001,
    SECCOMP_FILTER_FLAG_LOG => 0x00000002,
    SECCOMP_FILTER_FLAG_NEW_LISTENER => 0x00000008,
    SECCOMP_FILTER_FLAG_WAIT_KILLABLE_RECV => 0x00000020,
};
...
# close_range
# ═══════════════════════════════════════════════════════════════════════
use constant {CLOSE_RANGE_CLOEXEC => 0x00000004,};
